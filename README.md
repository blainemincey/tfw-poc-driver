...
This project is a slight modification from the POC Driver by John Page: https://github.com/johnlpage/POCDriver
All other instructions apply.  Final name of binary file in /bin is TFW-POCDriver.jar.

Specific fields are added to this version: claimType, claimAmount, dateClaimSubmitted. 

* claimType is a random string from a set list. 

* claimAmount is a random dollar amount up to 100000. 

* dateClaimSubmitted is a random date within the past 5 years.
